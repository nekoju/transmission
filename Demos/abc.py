...
# Automatically reload txmn. Remove after debugging.
...
# $\tau$, $\rho \sim \mathrm{Beta}(1, 1)$, and $\eta \sim \mathrm{N}(0, 0.1)$.
# This can be generated by the included command line tool `txmn-priorgen`
